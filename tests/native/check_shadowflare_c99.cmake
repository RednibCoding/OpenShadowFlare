...
foreach(source IN LISTS shadowflare_sources)
  ...
  if(relative_source MATCHES "^render/" AND
      contents MATCHES "#include[ \t]*\"(runtime|screens|ui)/")
    message(FATAL_ERROR "Rendering crossed into runtime/screen/UI code: ${source}")
  endif()
  ...
  if(relative_source MATCHES "^ui/" AND
      contents MATCHES "#include[ \t]*\"runtime/")
    message(FATAL_ERROR "UI depends on runtime integration: ${source}")
  endif()
